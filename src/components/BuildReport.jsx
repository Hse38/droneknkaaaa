    ...
    <div style={{ height:'100vh', overflow:'auto', background: mission?.bgGradient || 'linear-gradient(135deg,#060810,#0f172a)', padding:isMobile?12:24 }}>
      <div style={{ maxWidth:1180, margin:'0 auto', display:'flex', flexDirection:'column', gap:16 }}>
        ...
        <div style={{ display:'flex', justifyContent:'center', gap:10, flexWrap:'wrap' }}>
          ...
          <button onClick={() => onNewMission?.()} style={{ padding:'10px 16px', borderRadius:8, border:'none', background: mission?.color || 'var(--accent)', color:'#000', fontWeight:700 }}>DETAYLI TASARLA</button>
        </div>
      </div>
    </div>
  )
